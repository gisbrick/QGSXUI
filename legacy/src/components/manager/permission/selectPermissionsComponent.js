...
function SelectPermissionsComponent({ unit, user, addItem, excludeNames, setSelect}) {
    ...
    const columns = [
        ...
        },
        {
            ...
            ...getColumnSearchProps('usr', i18next.t('manager.permissions.name'),  setSearchText, setSearchedColumn)
        }]
...
export default SelectPermissionsComponent;