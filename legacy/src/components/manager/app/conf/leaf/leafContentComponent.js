...
import ConfigContentParentComponent from "./configContentParentComponent";
import ConfigContentLeafComponent from "./configContentLeafComponent";


function LeafContentComponent({ unit, config, setConf, permissions }) {
    ...
    const updateObject = (targetObject, obj) => {
    ...
    let renderParentToolbar = (nodeData) => {
        return <>&nbsp; &nbsp; <Space wrap>
            ...
            <Tooltip title={i18next.t('manager.app.contentTree.createParent')}>
                <FolderAddOutlined onClick={(e) => { createParent(nodeData); e.stopPropagation(); }} />
            </Tooltip>
            <Tooltip title={i18next.t('manager.app.contentTree.createLeaf')}>
    ...
    return (
        <>
                ...
                <Row justify={"start"}>
                    <div>
                        <div style={{ display: "inline-block", padding: "5px" }}>
                            <Button style={{ width: "auto" }} type="primary" onClick={createRootParent}>
                                <Space>
                                <FolderAddOutlined />
                                <div className="reader">{i18next.t('manager.app.contentTree.createRootParent')}</div>
                                </Space>
                        ...
                        <div style={{ display: "inline-block", padding: "5px" }}>
                            <Button type="primary" onClick={createRootLeaf}>
                                <Space>
                                <PlusOutlined />
                                <div className="reader">{i18next.t('manager.app.contentTree.createRootLeaf')}</div>
                                </Space>
            ...
            {configParent && <ConfigContentParentComponent unit={unit} config={configParent} isNew={isNew} setSelect={setConfigParent} saveParent={saveParent} permissions={permissions} />}
            {configLeaf && <ConfigContentLeafComponent unit={unit} config={configLeaf} isNew={isNew} setSelect={setConfigLeaf} saveLeaf={saveLeaf} permissions={permissions} />}
        </>
    );
}

export default LeafContentComponent;